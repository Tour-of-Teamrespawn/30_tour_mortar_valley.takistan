...
"
	...
	<br/>
	<br/>
	<t size='0.85' font='TahomaB' color='#D0D0D0' align='left' valign='top'>Rejecting %2 smoke with %1...</t>
", _id, _colour];
...
[player, _id, _colour, _unit] spawn
{
	...
	[
		(_this select 0),
		format ["Negative %1, %2 smoke is not correct! OVER", _this select 1, _this select 2],
		"side"
	] call TOUR_SI_fnc_broadcastMessage;

	sleep 5;

	(_this select 3) setVariable ["TOUR_SI_smokeConfirmed", false, true];
