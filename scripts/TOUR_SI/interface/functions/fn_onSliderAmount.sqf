...
[
	...
	"_supportType", "_commandType", "_textInfo", "_ammoclass", "_ammoText", "_ammotype", "_ammo", "_text1", "_text2", "_text3", "_text4", "_text5", "_arrayHeli", "_groupID", "_position"
];
...
switch (toLower _supportType) do
{
	case "artillery":
	{
	...
	
		{
			_x ctrlEnable true;
					...
					_comboType, _sliderAmountHeight, _sliderRadius, _sliderIntSpeed];
	...
	case "helicopter":
	{
		...
		{
			_x ctrlShow true;
		}forEach 	[_buttonExecute, _buttonConfirm,
	...
	case "plane":
	{
		...
		{
			_x ctrlShow true;
		}forEach 	[_buttonExecute, _buttonReject,
					_comboUnit, _comboType, _comboBehaviour,
					_sliderAmountHeight, _sliderRadius, _sliderIntSpeed,
					_textType, _textAmountHeight, _textRadius, _textIntSpeed, _textUnit, _textBehaviour];
